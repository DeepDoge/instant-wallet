...
export namespace Wallet {
    ...
    export async function connect(method: ConnectMethod, mode: "hard"): Promise<Wallet.Connected>;
    export async function connect(method: ConnectMethod, mode: "soft"): Promise<Wallet.Connected | Wallet.Disconnected>;
